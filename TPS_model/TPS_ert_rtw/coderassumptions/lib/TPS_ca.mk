###########################################################################
## Makefile generated for component 'TPS_ca'. 
## 
## Makefile     : TPS_ca.mk
## Generated on : Thu Apr 24 00:16:36 2025
## Final product: .\TPS_ca.lib
...
COMPILER_COMMAND_FILE     = TPS_ca_comp.rsp
CMD_FILE                  = TPS_ca.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
SRCS = $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\coder_assumptions_hwimpl.c $(MATLAB_ROOT)\toolbox\rtw\targets\pil\c\coder_assumptions_flt.c $(START_DIR)\TPS_ert_rtw\coderassumptions\TPS_ca.c
...
OBJS = coder_assumptions_hwimpl.obj coder_assumptions_flt.obj TPS_ca.obj
...
{$(START_DIR)\TPS_ert_rtw\coderassumptions}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TPS_ert_rtw\coderassumptions}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TPS_ert_rtw\coderassumptions\lib}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TPS_ert_rtw\coderassumptions\lib}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
TPS_ca.obj : "$(START_DIR)\TPS_ert_rtw\coderassumptions\TPS_ca.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TPS_ert_rtw\coderassumptions\TPS_ca.c"
