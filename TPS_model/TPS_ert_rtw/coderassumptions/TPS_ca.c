...
CA_HWImpl_TestResults CA_TPS_HWRes;
CA_PWS_TestResults CA_TPS_PWSRes;
const CA_HWImpl CA_TPS_ExpHW = {
  8,                                   /* BitPerChar */
  16,                                  /* BitPerShort */
  32,                                  /* BitPerInt */
  32,                                  /* BitPerLong */
...
void TPS_caRunTests(void)
{
  ...
  caVerifyPortableWordSizes(&CA_TPS_ActHW, &CA_TPS_ExpHW, &CA_TPS_PWSRes);
  caVerifyHWImpl(&CA_TPS_ActHW, &CA_TPS_ExpHW, &CA_TPS_HWRes);
}
