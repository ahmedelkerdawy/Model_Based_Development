###########################################################################
## Makefile generated for component 'TPS'. 
## 
## Makefile     : TPS.mk
## Generated on : Thu Apr 24 00:21:59 2025
## Final product: .\TPS.exe
...
MODELREF_LINK_RSPFILE     = TPS_ref.rsp
COMPILER_COMMAND_FILE     = TPS_comp.rsp
CMD_FILE                  = TPS.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
DEFINES_STANDARD = -DMODEL=TPS -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ..\TPS.obj

LIBS = $(START_DIR)\TPS_ert_rtw\coderassumptions\lib\TPS_ca.lib
...
xil_interface.obj : "$(START_DIR)\TPS_ert_rtw\sil\xil_interface.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TPS_ert_rtw\sil\xil_interface.c"


sil_main.obj : "$(START_DIR)\TPS_ert_rtw\sil\sil_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TPS_ert_rtw\sil\sil_main.c"
