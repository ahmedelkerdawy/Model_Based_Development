...
## 
## Makefile     : TPS.mk
## Generated on : Thu Apr 24 00:16:22 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\TPS.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\TPS.exe
...
SRCS = $(START_DIR)\TPS_ert_rtw\TPS.c

MAIN_SRC = $(START_DIR)\TPS_ert_rtw\ert_main.c
...
{$(START_DIR)\TPS_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TPS_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
TPS.obj : "$(START_DIR)\TPS_ert_rtw\TPS.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TPS_ert_rtw\TPS.c"


ert_main.obj : "$(START_DIR)\TPS_ert_rtw\ert_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TPS_ert_rtw\ert_main.c"
